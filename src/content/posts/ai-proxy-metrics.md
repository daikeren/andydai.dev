...
很多這類展示，最後展示的其實不是 production，而是一種 **theatricality**——流程感很強、畫面很滿，但不等於真的把重要事情做完。
...
我自己在 [Codeer](https://www.codeer.ai/) 看的也差不多就是這些，只是更具體一點。我不太在乎某個工程師今天叫了幾次 agent、燒了多少 token、讓 workflow 自己跑了多久。我比較在乎的是：這個 PR 到底能不能 merge？merge 之後會不會害別人更難接手？review 的時間是在抓真正的設計問題，還是在幫 AI 收爛尾？這次 iteration 有沒有讓我們更接近可上線的東西，而不是只多了一堆看起來很忙的中間產物？

這些問題一點都不新，也不酷，沒有 dashboard 味，也不適合拿來做社群炫耀。感覺很無聊，感覺很無聊，但它們比較接近現實。
