...
faqs:
  ...
  - question: 用 AI 產出內容和 AI Village 有什麼不同？
    answer: 差別在於「誰做決定」。用 AI 加速產出沒問題，但「要不要寄、寄給誰、內容是什麼」這些決定應該由人來做，每個產出都要有人 review 過。
  - question: 那條線在哪裡？
    answer: 很簡單：在還沒有 AI 之前你該怎麼做，有了 AI 之後你就該怎麼做。AI 不改變你的責任，只改變你的速度。
---
