...
更進一步說，我越來越覺得 AI 不會平均提高所有公司的生產力。它比較可能提高 productivity dispersion：好的組織被放大，爛的組織也被放大。

這篇想講的其實就是這三層：AI 加速 artifact production；bottleneck 從 production 移到 judgment；最後，AI 放大的不是每家公司，而是組織原本的品質。
